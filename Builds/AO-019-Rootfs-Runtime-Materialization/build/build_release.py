#!/usr/bin/env python3
"""Create an integrity-checkable AO-019 source release without package bytes."""
import hashlib,json,pathlib,zipfile
ROOT=pathlib.Path(__file__).resolve().parents[1];OUT=ROOT/"build-output";ARCHIVE=OUT/"AO-019-Rootfs-Runtime-Materialization.zip";OUT.mkdir(exist_ok=True)
