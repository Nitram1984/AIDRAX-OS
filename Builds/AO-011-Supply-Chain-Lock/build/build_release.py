#!/usr/bin/env python3
"""Create AO-011's deterministic source archive; never fetch supply-chain inputs."""
...
ARCHIVE = OUTPUT / "AO-011-Supply-Chain-Lock.zip"
EXCLUDED = {".git", "build-output", "__pycache__"}
