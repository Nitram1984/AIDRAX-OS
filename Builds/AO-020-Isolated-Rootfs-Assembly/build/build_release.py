#!/usr/bin/env python3
"""Package AO-020 sources, deliberately excluding the generated rootfs."""
import hashlib,json,pathlib,zipfile
ROOT=pathlib.Path(__file__).resolve().parents[1];OUT=ROOT/"build-output";ARCHIVE=OUT/"AO-020-Isolated-Rootfs-Assembly.zip"
